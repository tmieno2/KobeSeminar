...
Faculty of Agriculture, Forest Policy, Hokkaido University
...
+ "I don't have money" is not the reason you should give up on getting a graduate degree in U.S. 
...
+ Paths to getting Ag/Applied Econ Ph.D. in U.S. 
  * Get Master's in U.S. with funding, and get Ph.D. in U.S. with funding (this is what I did) 
  * Get Master's in Japan, and get Ph.D. in U.S. with funding (most people seem to follow this path)
...
+ Tuition waiver (no need to pay for courses you take)
...
+ tuition waiver (you do not pay for courses you take)
...
You have been heavily trained in this, and Japanese students are very good at this in general. 

.content-box-green[**How to improve**]

+ Read journal articles, magazines like Times, News Week, or news like New York Times. Do not feel compelled to read through all the articles. Pick topics what interests you
...
+ Listen to news and watch TV shows (pick ones that you enjoy) often (ideally <span style="color:blue"> everyday </span>)
  * I liked Ally McBeal, Scrubs, Friends, Game of Thrones
...
+ Do not do the above every time. You will get tired of it. 
...
+ These are the skills that you can learn most effectively if you are in U.S.
...
+ It is like learning how to use chopsticks, your brain gets trained to better associate your muscle movement and the brain image of your intended movement
  * e.g., Clarabel, parallel (moving your tong from "l" position to "r" position or vice versa is very difficult for us)
