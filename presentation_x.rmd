...
+ **Why matters?**: if well yield becomes low, then farmers cannot keep up with daily water demand of crop
  * loss in crop yield from irrigated field.
  * switch back to dryland production if well yield is too low

--

.content-box-red[**Important**]: As saturated thickness goes down, well yield goes down, which means that farmers are more vulnerable to drought 
...
+ Numerous studies have examined the impact of weather on crop yield from <span style="color:red"> dryland </span> production, but not many on from <span style="color:blue"> irrigated </span> production. 
